...
def generate_braille_model_from_text(text: str, output_path: str = "models/braille_model.stl") -> None:
    ...
    subprocess.run(
        ["openscad", "-o", output_path, "-D", f"chars={openscad_dot_lists}", "matrix_generator.scad"],
        capture_output=True,
        text=True
    )
